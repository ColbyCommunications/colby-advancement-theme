    ...
    <div class="search" v-if="modalOpen">
        ...
        >
            ...
            <div class="qs mb-12" role="region" aria-label="Query Suggestions`">
                <ais-index :index-name="suggestions" index-id="colby-qs">
    ...
    export default {
        ...
        props: {
            id: {
                type: String,
                required: false,
                default: 'prod_advancement_searchable_posts',
            },
            suggestions: {
                type: String,
                required: false,
                default: 'prod_advancement_searchable_posts_query_suggestions',
            },
        },
        methods: {
            search(query) {
