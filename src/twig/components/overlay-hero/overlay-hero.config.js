module.exports = {
  ...
  variants: [
    ...
    {
      name: 'Centered Large with Video',
      context: {
        align: 'center',
        video_loop: null,
        image: {
        ...
        size: 'xlarge',
        subheading: 'Give to Colby',
        heading: 'Dare Northward',
        paragraph: 'Extraordinary strides require extraordinary investments. Investments of time, effort, and resolve. But this campaign is worth the challenge. Because taking no risk is our greatest risk. Because we know the extraordinary is within reach as long as we dare for it.',
        buttons: null,
      }
    }
  ]
